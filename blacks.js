...
if (cmd) {
      switch (command) {
            ...
            const gothicFontMap = {
                'A': '𝕬', 'B': '𝕭', 'C': '𝕮', 'D': '𝕯', 'E': '𝕰', 'F': '𝕱', 'G': '𝕲', 'H': '𝕳', 'I': '𝕴', 'J': '𝕵', 'K': 'S', 'L': '𝕷', 'M': '𝕸', 'N': '𝕹', 'O': '𝕺', 'P': '𝕻', 'Q': '𝕼', 'R': '𝕽', 'S': '𝕾', 'T': '𝕿', 'U': '𝖀', 'V': '𝖁', 'W': '𝖂', 'X': '𝖃', 'Y': '𝖄', 'Z': '𝖅',
                'a': '𝖆', 'b': '𝖇', 'c': '𝖈', 'd': '𝖉', 'e': '𝖊', 'f': '𝖋', 'g': '𝖌', 'h': '𝖍', 'i': '𝖎', 'j': '𝖏', 'k': '𝖐', 'l': '𝖑', 'm': '𝖒', 'n': '𝖓', 'o': '𝖔', 'p': '𝖕', 'q': '𝖖', 'r': '𝖗', 's': '𝖘', 't': '𝖙', 'u': '𝖚', 'v': '𝖛', 'w': '𝖜', 'x': '𝖝', 'y': '𝖞', 'z': '𝖟',
                '0': '𝟎', '1': '𝟏', '2': '𝟐', '3': '𝟑', '4': '𝟒', '5': '𝟓', '6': '𝟔', '7': '𝟕', '8': '𝟖', '9': '𝟗'
            };
            const transformToGothic = (text) => {
                return text.split('').map(char => gothicFontMap[char] || char).join('');
            };

            const cap = `𝕳𝖊𝖞 𝖙𝖍𝖊𝖗𝖊, ${getGreeting()}
...
║ ✦ 𝕻𝖗𝖊𝖋𝖎𝖝: ${prefix}
║ ✦ 𝕸𝖔𝖉𝖊: ${mode}
║ ✦ 𝕾𝖕𝖊𝖊𝖉: ${Rspeed.toFixed(4)} 𝕸𝖘
║ ✦ 𝕿𝖎𝖒𝖊: ${getCurrentTimeInNairobi()} on ${date.toLocaleString('en-US', { weekday: 'long', timeZone: 'Africa/Nairobi'})}
║ ✦ 𝕬𝖛𝖆𝖎𝖑𝖆𝖇𝖑𝖊 𝕽𝕬𝕸: 32𝕲𝕭 𝖔𝖋 64𝕲𝕭 
╚═━════【🔒 𝕾𝖊𝖈𝖚𝖗𝖊】════━═╝
╔════════════════════╗
║   𝕿𝖍𝖊 𝕬𝖗𝖙 𝖔𝖋 𝕮𝖔𝖓𝖙𝖗𝖔𝖑   
╠════════════════════╣
║ 𝕿𝖍𝖊 𝕸𝖊𝖗𝖈𝖍𝖆𝖓𝖙 𝖆𝖑𝖜𝖆𝖞𝖘 𝖕𝖆𝖞𝖘 𝖍𝖎𝖘 𝖉𝖊𝖇𝖙𝖘. 
║   𝕻𝖔𝖜𝖊𝖗 𝖎𝖘 𝖆 𝖒𝖆𝖙𝖙𝖊𝖗 𝖔𝖋 𝖕𝖊𝖗𝖘𝖕𝖊𝖈𝖙𝖎𝖛𝖊.  
╚════════════════════╝
...
╔════════════════════════╗
║    𝕸𝖆𝖉𝖊 𝖇𝖞 𝖙𝖍𝖊 𝕶𝖎𝖓𝖌'𝖘 𝕿𝖊𝖈𝖍  
║       𝕭𝖑𝖆𝖈𝖐 𝕸𝖊𝖗𝖈𝖍𝖆𝖓𝖙
║    𝕸𝖆𝖉𝖊 𝕺𝖓 𝕰𝖆𝖗𝖙𝖍 𝕭𝖞 𝕳𝖚𝖒𝖆𝖓𝖘!
╚════════════════════════╝`;
            if (menu === 'VIDEO') {
